...
export interface GuildRoutes {
	guilds: {
		//.
		post(
			args: RestArguments<RequestMethod.Post, RESTPostAPIGuildsJSONBody>,
		...
		(id: string): {
			//.
			get(
				args?: RestArguments<RequestMethod.Get, RESTGetAPIGuildQuery>,
			): Promise<RESTGetAPIGuildResult>;
			//.
			patch(
				args: RestArguments<RequestMethod.Patch, RESTPatchAPIGuildJSONBody>,
			): Promise<RESTPatchAPIGuildResult>;
			//.
			delete(
				args?: RestArguments<RequestMethod.Delete>,
			): Promise<RESTDeleteAPIGuildResult>;
			webhooks: {
				//.
				get(
					args?: RestArguments<RequestMethod.Get>,
			...
			'audit-logs': {
				//.
				get(
					args?: RestArguments<RequestMethod.Get, RESTGetAPIAuditLogQuery>,
			...
			members: {
				...
				(id: string): {
					...
					roles(id: string): {
						//.
						put(
							args: RestArguments<RequestMethod.Put>,
			...
			bans: {
				//.
				get(
					args: RestArguments<RequestMethod.Get, RESTGetAPIGuildBansQuery>,
				...
				(userId: string): {
					...
					//.
					put(
						args: RestArguments<RequestMethod.Put, RESTPutAPIGuildBanJSONBody>,
			...
			integrations: {
				...
				(id: string): {
					...
					delete(
						args?: RestArguments<RequestMethod.Delete>,
					): Promise<RESTDeleteAPIGuildIntegrationResult>;
				};
			};
			'vanity-url': {
				//.
			...
			stickers: {
				...
				(id: string): {
					...
					delete(
						args?: RestArguments<RequestMethod.Delete>,
					): Promise<RESTDeleteAPIGuildStickerResult>;
				};
			};
			'scheduled-events': {
				//.
