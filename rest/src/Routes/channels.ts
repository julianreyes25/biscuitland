...
export interface ChannelRoutes {
	channels(id: string): {
		...
		//.
		patch(
			args: RestArguments<RequestMethod.Patch, RESTPatchAPIChannelJSONBody>,
		...
		'thread-members': {
			...
			(id: '@me'): {
				...
				): Promise<RESTPutAPIChannelThreadMembersResult>;
				//.
				delete(
					args?: RestArguments<RequestMethod.Delete>,
		...
		recipients: {
			(id: string): {
				...
				delete(
					args?: RestArguments<RequestMethod.Delete>,
				): Promise<RESTDeleteAPIChannelRecipientResult>;
			};
		};
		pins: {
			//.
		...
		permissions: {
			(id: string): {
				...
				delete(
					args?: RestArguments<RequestMethod.Delete>,
				): Promise<RESTDeleteAPIChannelPermissionResult>;
			};
		};
		invites: {
			//.
		...
		messages: {
			...
			(id: string): {
				...
				crosspost: {
					//.
					post(
						args: RestArguments<RequestMethod.Post>,
		...
		typing: {
			...
			post(
				args?: RestArguments<RequestMethod.Post>,
			): Promise<RESTPostAPIChannelTypingResult>;
		};
		webhooks: {
			//.
			get(
