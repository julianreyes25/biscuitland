...
import { OptionValuesLength } from '../../../mod.ts';
...
export abstract class SlashBaseOption<DataType extends SlashBaseOptionTypes> {
	...
	addLocalizations(
		locals: RestToKeys<[LocalizationMap, 'name', 'description']>,
	): this {
...
export type SlashRequiredOptionTypes = Exclude<
	SlashBaseOptionTypes,
	AACSGO | AACSGO
>;

export class SlashRequiredOption<DataType extends SlashRequiredOptionTypes>
	extends SlashBaseOption<DataType> {
...
export class SlashStringOption<AC extends boolean = boolean>
	extends SlashRequiredOption<APIApplicationCommandStringOption<AC>> {
	constructor(data: Partial<APIApplicationCommandStringOption<AC>> = {}) {
		super({ ...data, type: ApplicationCommandOptionType.String });
	}

	addChoices(
		choices: TypeArray<APIApplicationCommandOptionChoice<string>>,
	): SlashStringOption<true> {
...
export class SlashNumberOption<AC extends boolean = boolean>
	extends SlashRequiredOption<APIApplicationCommandNumberOption<AC>> {
	constructor(data: Partial<APIApplicationCommandNumberOption<AC>> = {}) {
		super({ ...data, type: ApplicationCommandOptionType.Number });
	}

	addChoices(
		choices: TypeArray<APIApplicationCommandOptionChoice<number>>,
	): SlashNumberOption<true> {
...
interface APIApplicationCommandIntegerOption<AC extends boolean = boolean>
	extends
		APIApplicationCommandOptionBase<ApplicationCommandOptionType.Integer> {
	/**
	 * If the option is an `INTEGER` or `NUMBER` type, the minimum value permitted.
	 */
	min_value?: number;
...
export class SlashIntegerOption<AC extends boolean = boolean>
	extends SlashRequiredOption<APIApplicationCommandIntegerOption<AC>> {
	constructor(data: Partial<APIApplicationCommandIntegerOption<AC>> = {}) {
		super({ ...data, type: ApplicationCommandOptionType.Integer });
	}
}

export class SlashUserOption
	extends SlashRequiredOption<APIApplicationCommandUserOption> {
	constructor(data: Partial<APIApplicationCommandUserOption> = {}) {
		super({ ...data, type: ApplicationCommandOptionType.User });
	}
}

export type SlashChannelOptionChannelTypes = Exclude<
	ChannelType,
	ChannelType.DM | ChannelType.GroupDM
>;

export class SlashChannelOption
	extends SlashRequiredOption<APIApplicationCommandChannelOption> {
...
export class SlashRoleOption
	extends SlashRequiredOption<APIApplicationCommandRoleOption> {
	constructor(data: Partial<APIApplicationCommandRoleOption> = {}) {
		super({ ...data, type: ApplicationCommandOptionType.Role });
	}
}

export class SlashMentionableOption
	extends SlashRequiredOption<APIApplicationCommandMentionableOption> {
	constructor(data: Partial<APIApplicationCommandMentionableOption> = {}) {
		super({ ...data, type: ApplicationCommandOptionType.Mentionable });
	}
}

export class SlashAttachmentOption
	extends SlashRequiredOption<APIApplicationCommandAttachmentOption> {
	constructor(data: Partial<APIApplicationCommandAttachmentOption> = {}) {
		super({ ...data, type: ApplicationCommandOptionType.Attachment });
	}
}

export class SlashBooleanOption
	extends SlashRequiredOption<APIApplicationCommandBooleanOption> {
...
export class SlashSubcommandOption
	extends SlashBaseOption<APIApplicationCommandSubcommandOption> {
	...
	addIntegerOption(
		fn: (option: SlashIntegerOption) => SlashIntegerOption,
	): this {
	...
	addChannelOption(
		fn: (option: SlashChannelOption) => SlashChannelOption,
	): this {
	...
	addMentionableOption(
		fn: (option: SlashMentionableOption) => SlashMentionableOption,
	): this {
	...
	addAttachmentOption(
		fn: (option: SlashAttachmentOption) => SlashAttachmentOption,
	): this {
	...
	addBooleanOption(
		fn: (option: SlashBooleanOption) => SlashBooleanOption,
	): this {
...
export type AllSlashOptions =
	| BasicSlashOptions
	| SlashSubcommandGroupOption
	| SlashSubcommandOption;

export class SlashSubcommandGroupOption
	extends SlashBaseOption<APIApplicationCommandSubcommandGroupOption> {
