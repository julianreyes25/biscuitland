...
export interface APIButtonComponent<WI extends boolean = boolean>
	extends
		APIButtonComponentBase<When<WI, ButtonStylesForID, ButtonStyle.Link>> {
	url: When<WI, never, string>;

	custom_id: When<WI, string, never>;
}

export class MessageButton<WI extends boolean = boolean>
	extends BaseComponent<APIButtonComponent<WI>> {
